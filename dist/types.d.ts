...
export type StandardEventType = 'page_view' | 'click' | 'form_submit' | 'performance' | 'exit' | 'modal_view' | 'random_uid_created';
...
export type EventData = PageViewEventData | ClickEventData | FormEventData | PerformanceEventData | ExitEventData | ModalEventData | CustomEventData;
...
export type PageType = 'landing_page' | 'support_kb' | 'blog' | 'legal' | 'pricing' | 'download' | 'other';
